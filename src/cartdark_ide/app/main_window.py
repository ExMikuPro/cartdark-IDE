...
from ..assets.assets_dock import AssetsDock
from ..panels.changed_files_dock import ChangedFilesDock
from ..panels.outline_dock import OutlineDock
from ..panels.properties_dock import PropertiesDock
from ..panels.bottom_dock import BottomDock
